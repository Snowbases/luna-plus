...
public:
	...
	void	DeleteQuest( CPlayer* player, CQuest* pQuest, DWORD param );
	void	UpdateQuest( CPlayer* player, DWORD dwFlag, DWORD dwParam, __time64_t registTime );
	...
	void	GiveQuestItem( CPlayer* pPlayer, DWORD dwQuestIdx, DWORD dwItemIdx, DWORD dwItemNum );
