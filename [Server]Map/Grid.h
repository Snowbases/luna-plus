...
//	void SendRemoveItemMsg(CObject* pLeavedObject);
	...
	WORD FindMonsterGroupInRange(CObject* pFinder,VECTOR3* pPos, DWORD* pObjectList);
...
public:
	...
	WORD FindMonsterGroupInRange(DWORD* pFriendsList, CObject* pFinder,VECTOR3* pPos);
