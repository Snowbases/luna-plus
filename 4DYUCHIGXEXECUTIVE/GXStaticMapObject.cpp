...
BOOL __stdcall CGXStaticMapObject::IsCollisionWithRay(VECTOR3* pv3IntersectPoint,DWORD* pdwModelIndex,DWORD* pdwObjIndex,float* pfDist,VECTOR3* pv3RayPos,VECTOR3* pv3RayDir,DWORD dwViewportIndex,DWORD dwFlag)
{
	BOOL		bResult = FALSE;
	DWORD		dwFaceGroupIndex;


	if (!m_pModel->IsCollisionMeshObject(pv3IntersectPoint,pfDist,&dwFaceGroupIndex,m_dwObjectIndex, pv3RayPos, pv3RayDir,dwFlag))
		goto lb_return;
