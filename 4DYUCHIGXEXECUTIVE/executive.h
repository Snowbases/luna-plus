...
//	void						RenderDecal();
	...
	BOOL							InitializeFileStorageCommon(DWORD dwMaxFileNum,DWORD dwMaxFileHandleNumAtSameTime,DWORD dwMaxFileNameLen,FILE_ACCESS_METHOD accessMethod,PACKFILE_NAME_TABLE* pPackFileList,DWORD dwNum, BOOL bFileShareMode);
public:
#ifdef _DEBUG
...
//	CoGXObject*					GetTracedGXObject() {return m_pTracedGXObject;}
	...
	BOOL				__stdcall	InitializeFileStorageWithoutRegistry(char* szFileName,DWORD dwMaxFileNum,DWORD dwMaxFileHandleNumAtSameTime,DWORD dwMaxFileNameLen,FILE_ACCESS_METHOD accessMethod,PACKFILE_NAME_TABLE* pPackFileList,DWORD dwNum,BOOL bFileShareMode=FALSE);
	BOOL				__stdcall	InitializeFileStorage(DWORD dwMaxFileNum,DWORD dwMaxFileHandleNumAtSameTime,DWORD dwMaxFileNameLen,FILE_ACCESS_METHOD accessMethod,PACKFILE_NAME_TABLE* pPackFileList,DWORD dwNum,BOOL bFileShareMode=FALSE);
...
//	void				__stdcall	GXOGetVelocity( GXOBJECT_HANDLE gxo, VECTOR3* pOutVelocity);
	...
	// 090422 ShinJS --- GXObject의 Parent Matrix 반환
