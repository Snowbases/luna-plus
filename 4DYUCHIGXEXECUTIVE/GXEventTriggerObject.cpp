...
BOOL __stdcall CoGXEventTrigger::IsCollisionWithRay(VECTOR3* pv3IntersectPoint,DWORD* pdwModelIndex,DWORD* pdwObjIndex,float* pfDist,VECTOR3* pv3RayPos, VECTOR3* pv3RayDir,DWORD dwViewportIndex,DWORD dwFlag)
{
	*pdwModelIndex = 0xffffffff;
	*pdwObjIndex = 0xffffffff;

	return IsCollisionMeshAndRay(pv3IntersectPoint,pfDist,&m_colMeshDesc,pv3RayPos,pv3RayDir);
}
