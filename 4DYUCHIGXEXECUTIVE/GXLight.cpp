...
BOOL __stdcall CoGXLight::IsCollisionWithRay(VECTOR3* pv3IntersectPoint,DWORD* pdwModelIndex,DWORD* pdwObjIndex,float* pfDist,VECTOR3* pv3RayPos, VECTOR3* pv3RayDir,DWORD dwViewportIndex,DWORD dwFlag)
{
	...
	*(VECTOR3*)&mat4._41 = m_LightDesc.v3Point;
	...
	dwIndex = m_pSymbolModel->GetMeshObjectWithRay(pv3IntersectPoint,pfDist,&dwFaceIndex,m_dwModelRefIndex,NULL,&mat4,0,0,pv3RayPos,pv3RayDir,dwFlag);
