...
lb_default_mtl:
	...
	//	pDevice->SetTextureStageState( 1, D3DTSS_COLOROP, D3DTOP_DISABLE);
		...
		if (pMtl->TextureBump.HasTexture())
		{
			...
			pDevice->SetTextureStageState( 0, D3DSAMP_ADDRESSU,D3DTADDRESS_WRAP);
			pDevice->SetTextureStageState( 0, D3DSAMP_ADDRESSV,D3DTADDRESS_WRAP);
			pDevice->SetTextureStageState( 0, D3DTSS_TEXCOORDINDEX, 0);
			pDevice->SetTextureStageState( 0, D3DTSS_TEXTURETRANSFORMFLAGS,D3DTTFF_DISABLE );
//			pDevice->SetTextureStageState( 1, D3DTSS_COLOROP, D3DTOP_ADDSIGNED);	
//			pDevice->SetTextureStageState( 0, D3DTSS_COLOROP, D3DTOP_MODULATE);	
...
/*
	...
	pDevice->SetFVF(m_pRenderer->GetShader(VL_TEST));
*/