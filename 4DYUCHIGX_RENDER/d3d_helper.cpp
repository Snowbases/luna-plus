...
{
	return pResourceManager->CreateVertexBuffer(dwSize,dwUsage,dwFVF,pool,(IDirect3DVertexBuffer9**)ppBuffer);
...
{
	return pResourceManager->CreateIndexBuffer(dwSize,dwUsage,D3DFMT_INDEX16 ,pool,(IDirect3DIndexBuffer9**)ppBuffer);
}
...
void __stdcall BeginAlphaMeshObject(LPDIRECT3DDEVICE9 pDevice,DWORD dwTexStageNum,DWORD dwMtlAlpha,DWORD dwObjAlpha)
{
...
/*
void ShadeLightTexture(LPDIRECT3DTEXTURE9 pLightTexture,TEXTURE_PLANE* pTexPlane,DWORD dwTexPlaneNum,LIGHT_DESC* pLight,DWORD dwLightNum,DWORD dwOffsetX,DWORD dwOffsetY)
{
...
/*
BOOL SetTextureWithBitmap(LPDIRECT3DDEVICE9 pDevice,LPDIRECT3DTEXTURE9 pTexDest,IMAGE_DESC* pImgDesc,D3DFORMAT format)
{
	BOOL				bResult = FALSE;
