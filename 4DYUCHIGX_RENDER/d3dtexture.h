...
protected:
	...
	LPDIRECT3DTEXTURE9			m_pBackupTexture;
	/*
...
public:
	...
	void						SetTexture(LPDIRECT3DDEVICE9 pDevice,DWORD dwTexStageIndex);

	void						SetTextureImage(LPDIRECT3DTEXTURE9 pTex,IMAGE_HEADER* pHeader)
	{
		m_pD3DTexture = pTex;
