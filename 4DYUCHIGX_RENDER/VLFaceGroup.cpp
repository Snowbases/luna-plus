...
BOOL CVLFaceGroup::CreateFaceGroup(CoD3DDevice* pRenderer,LPDIRECT3DDEVICE9 pDevice,VECTOR3* pv3,WORD* pIndex,DWORD* pVertexColor,DWORD dwFacesNum,DWORD dwFlag)
{
	BOOL	bResult = FALSE;
