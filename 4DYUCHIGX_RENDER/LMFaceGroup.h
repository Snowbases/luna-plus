...
public:
	LPDIRECT3DVERTEXBUFFER9		GetVertexBuffer() {return m_VB.GetVertexBuffer();}
	...
	BOOL						CreateFaceGroup(CoD3DDevice* pRenderer,LPDIRECT3DDEVICE9 pDevice,VECTOR3* pv3,TVERTEX* ptv,WORD* pIndex,TVERTEX* ptLightUV1,DWORD dwFacesNum,DWORD dwFlag);
