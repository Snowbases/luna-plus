...
BOOL C3DSprite::InitializeNameless(CoD3DDevice* pRenderer, DWORD dwWidth,DWORD dwHeight, TEXTURE_FORMAT TexFormat, DWORD dwFlag)
{
	...
	LPDIRECT3DTEXTURE9	pTex	=	m_Texture.GetTexture();
...
lb_render:
	...
	pDevice->DrawIndexedPrimitive(D3DPT_TRIANGLELIST, m_VB.GetStartIndex(), 0, 4, m_IB.GetStartIndex(), 2 );
...
{
	LPDIRECT3DTEXTURE9	pTexture	=	m_Texture.GetTexture();
	HRESULT		hResult;
