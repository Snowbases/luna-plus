...
BOOL CProjectionLight::GenerateLightMap(LPDIRECT3DDEVICE9 pDevice,DWORD dwRS,DWORD dwColor,DWORD dwFlag)
{
	BOOL		bResult = FALSE;
...
void CProjectionLight::CreateAttenuationMap(LPDIRECT3DTEXTURE9 pTexture,DWORD dwWidth,DWORD dwHeight,DWORD dwRS,DWORD dwColor)
{
	D3DLOCKED_RECT	rect;
	WORD*			p;
	DWORD			x,y;
