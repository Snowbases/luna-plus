...
{
	BOOL	bResult;
	bResult = m_D3DRCBufferHeap.AllocBuffer(pdwErrorCode,(IDirect3DResource9**)&pIndexBuffer->m_pIB,&pIndexBuffer->m_pIBHandle,&pIndexBuffer->m_dwStartIndex,NULL,dwIndicesNum,pbEnable,pResourceController);
	if (!bResult)
		goto lb_return;
