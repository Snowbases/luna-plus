...
public:
	...
	void							SetDefaultDiffuseTexture(LPDIRECT3DDEVICE9 pDevice,DWORD dwTexStageIndex) 
	{
		m_DefaultDiffuseTexture.SetTexture(pDevice,dwTexStageIndex);
	}
	void							SetDefaultBumpTexture(LPDIRECT3DDEVICE9 pDevice,DWORD dwTexStageIndex) 
	{
