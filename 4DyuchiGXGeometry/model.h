...
public:	
	...
	DWORD			__stdcall	GetMeshObjectWithRay(VECTOR3* pv3IntersectPoint,float* pfDist,DWORD* pdwFaceGroupIndex,DWORD dwRefIndex,MATRIX4* pParent,MATRIX4* pTransform,DWORD dwFrame,DWORD dwMotionIndex,VECTOR3* pv3RayPos,VECTOR3* pv3RayDir,DWORD dwFlag);
	DWORD			__stdcall	GetMeshObjectWithRayAndMatrix(VECTOR3* pv3IntersectPoint,float* pfDist,DWORD* pdwFaceGroupIndex,DWORD dwRefIndex,MATRIX4* pParent,MATRIX4* pTransform,DWORD dwFrame,DWORD dwMotionIndex,VECTOR3* pv3RayPos,VECTOR3* pv3RayDir,DWORD dwFlag);
	...
	DWORD			__stdcall	GetMeshObjectWithBoundingBox(VECTOR3* pv3IntersectPoint,float* pfDist,DWORD* pdwFaceGroupIndex,DWORD dwRefIndex,MATRIX4* pParent,MATRIX4* pTransform,DWORD dwFrame,DWORD dwMotionIndex,COLLISION_MESH_OBJECT_DESC* pSrcColDesc,DWORD dwFlag);
