...
public:	
	...
	DWORD			__stdcall	GetMultipleMeshObjectWithRay(PICK_GXOBJECT_DESC* pPickDesc, DWORD dwMaxDescNum, VECTOR3* pv3RayPos,VECTOR3* pv3RayDir,DWORD dwFlag);
	...
	BOOL			__stdcall	IsCollisionMeshObject(VECTOR3* pv3IntersectPoint,float* pfDist,DWORD* pdwFaceGroupIndex,DWORD dwObjIndex,VECTOR3* pv3RayPos,VECTOR3* pv3RayDir,DWORD dwFlag);
