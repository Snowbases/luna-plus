...
CFamilyPointLogCommand::CFamilyPointLogCommand( CclientApp& application, const TCHAR* title, DWORD familyIndex ) :
CCommand( application, title ),
mFamilyIndex( familyIndex )
{}


void CFamilyPointLogCommand::SaveToExcel( DWORD serverIndex, const CListCtrl& listCtrl ) const
{
	CString textHead;
...
void CFamilyPointLogCommand::Find( DWORD serverIndex, const TCHAR* beginTime, const TCHAR* endTime )
{
...
void CFamilyPointLogCommand::Stop( DWORD serverIndex ) const
{
	MSGROOT message;
	ZeroMemory( &message, sizeof( message ) );
...
void CFamilyPointLogCommand::Parse( const MSGROOT* message, CListCtrl& listCtrl, CProgressCtrl& progressCtrl, CStatic& resultStatic, CButton& findButton, CButton& stopButton ) const
{
