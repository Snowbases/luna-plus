...
void CConsignLogCommand::Initialize(CListCtrl& listCtrl) const
{
	...
	const Field fieldArray[] = {
		...
		{IDS_STRING522, 100, LVCFMT_RIGHT}, // 판매대행 번호
		{IDS_STRING54, 80, LVCFMT_RIGHT}, // 플레이어 번호
		{IDS_STRING4, 70, LVCFMT_LEFT}, // 로그 종류
		{IDS_STRING482, 100, LVCFMT_RIGHT}, // 아이템 DB번호
		{IDS_STRING189, 0, LVCFMT_RIGHT}, // 아이템 번호
		{IDS_STRING189, 100, LVCFMT_LEFT}, // 아이템 이름
