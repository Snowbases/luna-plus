...
interface IDIFontObject : public IUnknown
{
	...
	virtual		BOOL		__stdcall	DrawText(TCHAR* str,DWORD dwLen,RECT* pRect,DWORD dwColor,CHAR_CODE_TYPE type,DWORD dwFlag, void* sprite) = 0;
...
interface I4DyuchiGXRenderer : public IUnknown
{
	...
	virtual		void*				__stdcall	GetD3DDevice() = 0;
