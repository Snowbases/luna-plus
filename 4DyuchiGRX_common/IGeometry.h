...
{	
	...
	virtual DWORD			__stdcall	GetMultipleMeshObjectWithRay(PICK_GXOBJECT_DESC* pPickDesc, DWORD dwMaxDescNum, VECTOR3* pv3RayPos,VECTOR3* pv3RayDir,DWORD dwFlag) = 0;
	...
	virtual	BOOL			__stdcall	IsCollisionMeshObject(VECTOR3* pv3IntersectPoint,float* pfDist,DWORD* pdwFaceGroupIndex,DWORD dwObjIndex,VECTOR3* pv3RayPos,VECTOR3* pv3RayDir,DWORD dwFlag) = 0;
...
interface I3DModel : public IUnknown
{
	...
	virtual DWORD			__stdcall	GetMeshObjectWithRay(VECTOR3* pv3IntersectPoint,float* pfDist,DWORD* pdwFaceGroupIndex,DWORD dwRefIndex,MATRIX4* pParent,MATRIX4* pTransform,DWORD dwFrame,DWORD dwMotionIndex,VECTOR3* pv3RayPos,VECTOR3* pv3RayDir,DWORD dwFlag) = 0;
	...
	virtual DWORD			__stdcall	GetMeshObjectWithBoundingBox(VECTOR3* pv3IntersectPoint,float* pfDist,DWORD* pdwFaceGroupIndex,DWORD dwRefIndex,MATRIX4* pParent,MATRIX4* pTransform,DWORD dwFrame,DWORD dwMotionIndex,COLLISION_MESH_OBJECT_DESC* pSrcColDesc,DWORD dwFlag) = 0;
