...
private:
	...
	static void OnFakeStorageItemDivideCancel( LONG iId, void* p, DWORD param1, void * vData1, void * vData2 );
	static void OnFakeStorageItemDivideOk( LONG iId, void* p, DWORD param1, void * vData1, void * vData2 );
};
