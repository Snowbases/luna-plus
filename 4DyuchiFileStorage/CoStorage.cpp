...
void* __stdcall CoStorage::MapPackFile(char* szPackFileName, BOOL bFileShareMode)
{
	...
	bResult = pPackFile->Initialize(this,m_pFileItemNameHash,szPackFileName,bFileShareMode);
